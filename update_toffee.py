...
def generate():
    ...
    # যদি স্ক্র্যাপার ফেল করে, তবে আপনার জানা শেষ সচল কুকিটি ব্যাকআপ হিসেবে থাকবে
    if not cookie:
    ...
    for ch in channels:
        ...
        # VLC/libvlc সরাসরি এই হেডারগুলো ব্যবহার করে প্লে করবে
        m3u += f'#EXTINF:-1, {ch["name"]}\n'
        m3u += f'#EXTVLCOPT:http-user-agent={ua}\n'
        m3u += f'#EXTVLCOPT:http-referrer=https://toffeelive.com/\n'
